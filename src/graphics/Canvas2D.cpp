...
LNCanvas2D::LNCanvas2D(SDL_Window *window) : surface(SDL_GetWindowSurface(window)), window(window) {}
...
int LNCanvas2D::fillRect(const SDL_Rect *rect, Uint32 color) { return SDL_FillRect(LNCanvas2D::surface, rect, color); }
