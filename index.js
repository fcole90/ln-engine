...
var ASM_CONSTS = {
 ...
 131108: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 131191: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 131260: () => { return window.innerWidth; },  
 131290: () => { return window.innerHeight; }
};
